import { type AnimTempoNumbers, type DTAStringifyFormats, type PartialDTAFile } from '../core.js'
import { capitalizeFirstLetter, quoteToSlashQ, type AudioTracksCountObject } from '../lib.js'
 ...
 * @returns {string} The new formatted string.
 */
export const renderAnimTempo = (animTempo: AnimTempoNumbers, format: DTAStringifyFormats) => {
 ...
 * @returns {string} The new formatted string.
 */
export const renderCustomAttributes = (song: PartialDTAFile) => {
  let content = ''

 ...
 * - - - -
 * @param {DefaultOptionsObject<T, R>} defaultOptions The default options of the function.
 * @param {T | undefined} userOptions `OPTIONAL`: User-provided options with properties to override any default option property. If `undefined` or an empty object, no default properties will be replaced.
 * @returns {DefaultOptionsObject<T, R>} The default options merged with given user options.
 */

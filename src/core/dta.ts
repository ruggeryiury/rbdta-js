...
import { dtaLocale, type AnimTempoNumbers, type BandFailCue, type DrumBank, type ExtraAuthoringFlags, type PercussionBank, type SoloFlags, type SongEncoding, type SongGameOrigin, type SongGenre, type SongKey, type SongRating, type SongScrollSpeed, type SongSubGenre, type SongTonality, type VocalGender, type VocalParts } from '../core.js'
